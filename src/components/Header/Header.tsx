...
export const Header: React.FC = () => <header className="fixed top-0 left-0 w-full z-50">
  <div className="container mx-auto h-full flex items-center py-8">
    ...
    <a href="https://api.codementoring.co" className="btn btn-secondary btn-large ml-4">login</a>
  </div>
</header>;
